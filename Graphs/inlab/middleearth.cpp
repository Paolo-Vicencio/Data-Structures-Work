...
/**
 * This function shuffles the vector randomly using the Mersenne Twister
 * engine.
 */
...
/**
 * List of places in Middle Earth
 */
...
/**
 * This is a more detailed constructor taking in width
 * height, number of cities total, and how many to visit
 */
...
/**
 * This function prints out the various information on
...
/**
 * Prints out a different form of the new information in an excel table
 * format
 */
...
/**
 * This function calculates the distance traveled between the
 * two cities
 */
...
/**
 * Grabs the starting and end points of the journey
 */
