...
private:
    ...
    AVLNode* insert(const string& x, AVLNode*& n) ;
    // helper numnodes method
    int numNodesHelper(AVLNode* n) const;
    // helper pathTo method
    string pathToHelper(const string& x, AVLNode* n) const ;
};
